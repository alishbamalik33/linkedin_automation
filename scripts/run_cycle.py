...
def run_cycle(args=None):
    ...
    try:
        ...
        for i, job in enumerate(jobs_to_process, 1):
            ...
            try:
                # A. Tailor resume
                # A. Generate tailored application content with Gemini
                logger.info("  Generating tailored application content with Gemini...")

                ai_result = gemini.generate_job_materials(
                ...
                logger.info("  Gemini generated resume summary and competencies.")
                ...
                resume_path = tailor.tailor_and_save(
                     ...
                     new_summary=ai_result["summary"],
                     new_competencies=ai_result["competencies"],
                     company=company,
                     role=role,
                     output_dir=job_dir,
                     )
